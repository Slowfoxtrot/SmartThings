 ...
 *
 *  2014-09-19: GUI Tweaks, HEM v1 alterations
 *				- Reworked for HEM v1 compatibility
...
// v1		fingerprint deviceId: "0x2101", inClusters: " 0x70,0x31,0x72,0x86,0x32,0x80,0x85,0x60"
	...
	// Power row
		...
		valueTile("energyDisp", "device.energyDisp") {//, decoration: "flat") {
			state("default", label: '${currentValue}', /*icon: "st.motion.acceleration.active",*/ backgroundColor:"#ffffff")
